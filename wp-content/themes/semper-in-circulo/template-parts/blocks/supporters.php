...
<div class="sic-komitee-wrapper mt-4">
    ...
    <div class="komitee-form-wrapper mt-10" id="beitreten">
        ...
        <form action="#" class="sic-api-form mt-4" data-endpoint="/api/v1/supporter">
            ...
            <div class="sic-alertBar p-3 leading-none my-4 w-full border-2 border-accent-120 bg-accent-20 border-solid text-accent-120 font-semibold" hidden></div>
            <div class="sic-form-wrapper sic-form-content" data-step="current">
